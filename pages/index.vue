...
<template>
  <div class="mainpage">
    <div class="hlaseni-input-container">
      <h5>Hlášený text</h5>
      <UTextarea v-model="hlaseniTextValue" />
      <br>
      <h5>Rychlost mluvy</h5>
